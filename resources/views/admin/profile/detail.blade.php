        ...
        <div class="d-block bg-white rounded-3 border shadow-sm">
            ...
            <div class="p-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="address" id="address" class="form-control" rows="3" disabled>{{ $data->address }}</textarea>
                </div>
                <a href="{{ route('admin.account.update',['id' => $data->admin_id]) }}" class="btn btn-outline-primary">Edit Profile</a>
                <a href="{{ route('admin.account',['id' => $data->admin_id])}}" class="btn btn-outline-danger">Kembali</a>
            </div>
        </div>
    </div>
@endsection
