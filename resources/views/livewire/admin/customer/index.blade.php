                            ...
                            <tr>
                                ...
                                <th class="text-them">
                                    <div class="tb-admin-image"
                                        style="background-image: url('/images/avatar/{{ $item->avatar }}')">
                                    </div>
                                </th>
                                <td>{{ $item->username }}</td>
                                <td>{{ $item->email }}</td>
                                    ...
                                    <div class="dropstart">
                                        ...
                                        <div class="dropdown-menu position-fixed border-0 shadow" style="width: 200px">
                                            <a class="dropdown-item link-black"
                                                href="{{ route('admin.customer.detail', ['id' => $item->user_id]) }}">
                                            ...
                                            @else
                                                <button class="dropdown-item "
                                                    wire:click="DeleteAction({{ $item->user_id }})">
                                                    <i class="fas fa-trash fa-sm me-3"></i> Delete Data
                                                </button>
                                            @endif
                                        </div>
