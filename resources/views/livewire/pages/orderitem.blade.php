        ...
        @if (session('cart'))
                            ...
                            <div class="col-md-9">
                                <div class="card-body">
                                    ...
                                    <button wire:click="removeSession({{ $cart['product_id'] }})" type="button"
                                        class="btn btn-danger btn-sm position-absolute bottom-0 end-0 m-2">Remove</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-4">
                <div class="card p-3">
                    ...
                    <hr>
                    <button  wire:click="placeOrder" class="btn btn-success w-100">Buat Pesanan</button>
                </div>
            </div>
        @else
            <div class="col-12">
